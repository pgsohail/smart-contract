...
fn farm_staking_boosted_rewards_no_energy_test() {
    ...
    fs_setup.check_farm_token_supply(farm_in_amount + 1);
    ...
    fs_setup
        ...
        .execute_query(&fs_setup.farm_wrapper, |sc| {
            let user_boosted_rewards = sc
                ...
                .get();
            assert_eq!(user_boosted_rewards, managed_biguint!(9));
        })
        .assert_ok();
}
...
fn farm_staking_claim_boosted_rewards_for_user_test() {
    ...
    let expected_boosted_reward_token_out = 9;
    let expected_farming_token_balance =
...
fn farm_staking_full_position_boosted_rewards_test() {
    ...
    fs_setup.stake_farm(farm_in_amount, &[], 2, 0, 0);
    fs_setup.stake_farm(farm_in_amount, &[], 3, 0, 0);
    fs_setup.check_farm_token_supply(farm_in_amount * 2 + 1);
